...
export type DishPartsFragment = { id: number, name: string, price: number, photo?: string | null, description: string, options?: Array<{ name: string, extra?: number | null, choices?: Array<{ name: string, extra?: number | null }> | null }> | null };

export type OrderPartsFragment = { id: number, createdAt: any, total?: number | null };

export type FullOrderPartsFragment = { id: number, total?: number | null, status: OrderStatus, driver?: { email: string } | null, customer: { email: string }, restaurant?: { name: string } | null };
...
export type RestaurantQuery = { restaurant: { ok: boolean, error?: string | null, restaurant?: { id: number, name: string, coverImg?: string | null, address: string, isPromoted: boolean, menu: Array<{ id: number, name: string, price: number, photo?: string | null, description: string, options?: Array<{ name: string, extra?: number | null, choices?: Array<{ name: string, extra?: number | null }> | null }> | null }>, category?: { name: string } | null } | null } };
...
export type CreateOrderMutation = { createOrder: { ok: boolean, error?: string | null, orderId?: number | null } };
...
export type CookedOrdersSubscription = { cookedOrders: { id: number, total?: number | null, status: OrderStatus, driver?: { email: string } | null, customer: { email: string }, restaurant?: { name: string } | null } };
...
export type TakeOrderMutation = { takeOrder: { ok: boolean, error?: string | null } };
...
export type GetOrderQuery = { getOrder: { ok: boolean, error?: string | null, order?: { id: number, total?: number | null, status: OrderStatus, driver?: { email: string } | null, customer: { email: string }, restaurant?: { name: string } | null } | null } };
...
export type OrderUpdatesSubscription = { orderUpdates: { id: number, total?: number | null, status: OrderStatus, driver?: { email: string } | null, customer: { email: string }, restaurant?: { name: string } | null } };
...
export type EditOrderMutation = { editOrder: { ok: boolean, error?: string | null } };
...
export type CreateDishMutation = { createDish: { ok: boolean, error?: string | null } };
...
export type MyRestaurantQuery = { myRestaurant: { ok: boolean, error?: string | null, restaurant?: { id: number, name: string, coverImg?: string | null, address: string, isPromoted: boolean, menu: Array<{ id: number, name: string, price: number, photo?: string | null, description: string, options?: Array<{ name: string, extra?: number | null, choices?: Array<{ name: string, extra?: number | null }> | null }> | null }>, orders: Array<{ id: number, createdAt: any, total?: number | null }>, category?: { name: string } | null } | null } };
...
export type CreatePaymentMutation = { createPayment: { ok: boolean, error?: string | null } };

export type PendingOrdersSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type PendingOrdersSubscription = { pendingOrders: { id: number, total?: number | null, status: OrderStatus, driver?: { email: string } | null, customer: { email: string }, restaurant?: { name: string } | null } };
