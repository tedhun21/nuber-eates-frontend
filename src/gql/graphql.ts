...
export type RestaurantPartsFragment = { id: number, name: string, coverImg?: string | null, address: string, isPromoted: boolean, category?: { name: string } | null } & { ' $fragmentName'?: 'RestaurantPartsFragment' };
...
export type SearchRestaurantQuery = { searchRestaurant: { ok: boolean, error?: string | null, totalPages?: number | null, totalResults?: number | null, restaurants?: Array<{ ' $fragmentRefs'?: { 'RestaurantPartsFragment': RestaurantPartsFragment } }> | null } };
